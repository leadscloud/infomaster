...
(function ($) {
    ...
    $.fn.check_pass_strength = function(user,pass1,pass2) {
        ...
        switch ( strength ) {
            case 2:
                this.addClass('label-info').html( '弱' );
                break;
            case 3:
                this.addClass('label-inverse').html( '中等' );
                break;
            case 4:
                this.addClass('label-success').html( '强' );
                break;
            case 5:
                this.addClass('label-important').html( '不匹配' );
                break;
            default:
                this.addClass('label-warning').html( '非常弱' );
        }
        return this;
    };
    /*
	...
	$.fn.draggable = function(contents) {
        ...
        return $element.css('cursor', contents.cursor).on("mousedown", function(e) {
			if($(e.target).is('input,textarea,select,button,.btn,.modal-body')) return '';
            onDragStart($(this));
