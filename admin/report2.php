...
function post_manage_page($action) {
	...
	echo "id: ".generate_identifier2($postid);
...
function generate_identifier2($postid){
	...
	print_r(array( 'identifier' => strtoupper($identifier) ));
	return mb_strtoupper($identifier, 'utf-8');
...
function display_select($selected , $num){
	...
	$text = array(array('世邦电商一部','电商二部','西芝电商一部','世邦国内电商','电商三部'),
				array('商务通','B2B','主动营销','办事处','报纸杂志','电话','技术员','网站留言','展会','直接来信','SNS','其它'),
				array('英语','中文','俄语','西语','阿语','法语','葡语','印尼语','泰语','波斯语','蒙古语','越南语','其它'),
